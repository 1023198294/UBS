...
if __name__ == '__main__':
    ...
    #parser.add_argument('--train_root', type=str, default='datasets/Amazon_Beauty/train.txt')
    #parser.add_argument('--test_root', type=str, default='datasets/Amazon_Beauty/test.txt')
