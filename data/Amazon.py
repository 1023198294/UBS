...
class Books(DataSet):
    def __init__(self):
        ...
        self.user_record_file = 'K=10_BS=100_item_sequences.pkl'
...
class MI(DataSet):
    def __init__(self):
        self.dir_path = './data/dataset/Amazon/MI/'
        self.user_record_file = 'MI_K=1_BS=100_item_sequences.pkl'
        self.user_mapping_file = 'MI_K=1_BS=100_user_mapping.pkl'
        self.item_mapping_file = 'MI_K=1_BS=100_item_mapping.pkl'

        #self.user_record_file = 'MI_item_sequences.pkl'
        #self.user_mapping_file = 'MI_user_mapping.pkl'
        #self.item_mapping_file = 'MI_item_mapping.pkl'
